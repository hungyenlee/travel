...
本資料夾的照片皆取自 **Wikimedia Commons**，授權為 CC BY-SA（姓名標示—相同方式分享）。
依授權需標示作者與授權條款，以下為各檔案的出處。

| 檔案 | 縣市／地標 | 作者 | 授權 | 原始頁面 |
|---|---|---|---|---|
| `tainan.jpg` | 台南・奇美博物館 | mershells | CC BY 2.0 | https://commons.wikimedia.org/wiki/File:Trial_operation_of_Chimei_Museum.jpg |
| `kaohsiung.jpg` | 高雄・愛河（愛河之心） | 汪大雄（Flickr） | CC BY-SA 2.0 | https://commons.wikimedia.org/wiki/File:Heart_of_Love_River_Ruyi_Lake.jpg |
...
> 照片經等比例縮圖（寬約 1400px）以利網頁載入，未修改內容。
